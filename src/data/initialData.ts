...
export const initialEmails: SimulatedEmail[] = [
  {
    ...
    subject: 'Gmail unread - Test On Thu, Jan 21, 2026',
    body: `Hi team,\n\nThis is a priority verification test for our newly launched VAWAY Business Email platform. All MX, SPF, DKIM, and DMARC records have aligned successfully with 100% deliverability rating to major webmail providers.\n\nPlease review the attached screenshots and confirmation tokens.`,
    ...
    important: true,
    labels: [
      { name: 'Priority Task', color: 'gray' },
      { name: 'Screen...', color: 'red' },
      { name: 'Screen...', color: 'red' },
      { name: 'Screen...', color: 'red' },
    ],
    spamScore: 0.0,
  ...
  {
    id: 'msg-gmail-2',
    from: 'updates@asana.com',
    senderName: 'Asana',
    to: 'admin@example.com',
    subject: "Your Thursday update - IT - Hi Alphr, here's your daily tasks summary",
    body: `Here is what is due today in your workspace:\n\n1. [In Progress] DNS DKIM Selector validation for vaway.com\n2. [Review] SendGrid & Amazon SES Outbound Smart Host Relay\n3. [Completed] Storage compression set to gz (level 6)\n\nVisit Asana to update your project status.`,
    date: '2026-09-04 04:01',
    timeDisplay: '4:01 AM',
    folder: 'inbox',
    category: 'primary',
    read: true,
  ...
  {
    id: 'msg-gmail-3',
    from: 'productivity@asana.com',
    senderName: 'Asana',
    to: 'admin@example.com',
    subject: "Time flies when you're getting productive - Keep up the great momentum!",
    body: `You completed 14 tasks this week! That is 35% higher than your average. Check out the workflow insights to see which automations saved the most hours.`,
    date: '2026-09-04 02:09',
    timeDisplay: '2:09 AM',
    folder: 'inbox',
    category: 'primary',
    read: true,
  ...
  },
  {
    id: 'msg-gmail-4',
    from: 'ivan@notion.so',
    senderName: 'Ivan at Notion',
    to: 'admin@example.com',
    subject: 'How to work with other people in Notion - Work together seamlessly',
    body: `Hey there,\n\nSharing pages in Notion is as simple as clicking the 'Share' button in the top right. You can invite team members to collaborate in real-time, leave inline comments, and assign tasks with @mentions.\n\nEnjoy collaborating!`,
    date: '2026-09-03 23:06',
    timeDisplay: '11:06 PM',
    folder: 'inbox',
    category: 'primary',
    read: true,
    starred: false,
  ...
  {
    id: 'msg-gmail-5',
    from: 'no-reply@pxhere.com',
    senderName: 'PxHere',
    to: 'admin@example.com',
    subject: 'PXHere - Verification of register - Hello TJguides, welcome!',
    body: `Thank you for signing up with PxHere Free High Quality Stock Photos.\n\nPlease click the button below to confirm your email address and activate your free CC0 downloads.`,
  ...
  {
    id: 'msg-gmail-6',
    from: 'digest@asana.com',
    senderName: 'Asana',
    to: 'admin@example.com',
    subject: "Your Wednesday update - IT - Hi Alphr, here's your mid-week status",
    body: `Team sprint review meeting scheduled for Friday at 10:00 AM UTC. 3 tasks need approvals before deployment.`,
  ...
  {
    id: 'msg-gmail-7',
    from: 'growth@tailorbrands.com',
    senderName: 'Tailor Brands Team',
    to: 'admin@example.com',
    subject: 'How to get more customers through writing ✍️ - New branding guide',
    body: `Copywriting is the highest leverage marketing channel for SaaS startups. Here are the 5 core principles of compelling brand storytelling.`,
  ...
  {
    id: 'msg-gmail-8',
    from: 'notifications@asana.com',
    senderName: 'Asana',
    to: 'admin@example.com',
    subject: "Your Tuesday update - IT - Hi Alphr, here's your dashboard summary",
    body: `Sprint backlog prioritized. All high-priority tickets assigned to team members.`,
    date: '2026-01-19 08:45',
    timeDisplay: 'Jan 19',
    folder: 'inbox',
    category: 'social',
    read: true,
  ...
  },
  {
    ...
    senderName: 'GitHub 2',
    to: 'admin@example.com',
    subject: '[GitHub] A first-party GitHub OAuth application has been authorized',
    body: `Hey there!\n\nA third-party OAuth application was recently authorized to access your GitHub account. If you did not initiate this action, please visit your security settings to revoke access.`,
    date: '2026-01-19 11:18',
    timeDisplay: 'Jan 19',
    folder: 'inbox',
    category: 'social',
    read: true,
  ...
  {
    id: 'msg-gmail-10',
    from: 'community@github.com',
    senderName: 'GitHub',
    to: 'admin@example.com',
    subject: "You're officially a part of the community - GitHub welcome pack",
    body: `Welcome to GitHub! Explore millions of open-source repositories, collaborate with developers across the globe, and contribute to great software.`,
  ...
  },
  {
    ...
    senderName: 'GitHub',
    to: 'admin@example.com',
    subject: '[GitHub] Please verify your email address. - To secure your account',
    body: `Please verify your email address by clicking the verification link below. Once verified, you will be able to push repositories and create issues.`,
  ...
  },
  {
    ...
    starred: true,
    important: true,
    labels: [{ name: 'Priority Task', color: 'gray' }],
    spamScore: 0.1,
    dkimStatus: 'pass',
    spfStatus: 'pass',
    avatarColor: '#1a73e8',
  ...
  },
  {
    ...
    subject: 'Q3 Enterprise SaaS Email Growth Projections',
    body: `Draft report on multi-tenant SaaS email hosting capacity...`,
